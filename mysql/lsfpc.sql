...
CREATE DATABASE IF NOT EXISTS ligasolidaria;
USE ligasolidaria;
...
(1,1,'IES Augusto González de Linares','https://www.iesaglinares.com/',NULL,'Av. Primero de Mayo, 1, 39011 Santander, Cantabria',NULL),
(2,1,'IES Peñacastillo','https://www.educantabria.es/web/ies-penacastillo',NULL,'C. Eduardo García, 0, 39011 Santander, Cantabria',NULL),
(3,3,'IES Fuente Fresnedo','https://iesfuentefresnedo.es/',NULL,'C. Reconquista de Sevilla, 45, 39770 Laredo, Cantabria',NULL),
(4,3,'IES Ataulfo Argenta','http://iesataulfoargenta.es/wp/',NULL,'P.º Menéndez Pelayo, 4, 39700 Castro-Urdiales, Cantabria',NULL),
(5,2,'IES Besaya','https://www.educantabria.es/centros/buscador-de-centros/39009456-ies-besaya',NULL,'Av. Oviedo, 2, 39300 Torres, Cantabria',NULL),
(6,2,'IES Miguel Herrero Pereda','https://www.educantabria.es/web/ies-miguel-herrero-pereda',NULL,'P.º de Julio Hauzeur, 59, 39300 Torrelavega, Cantabria',NULL),
(7,2,'IES Zapatón','https://www.ieszapaton.es/',NULL,'Av. de la Constitución, 7, 39300 Torrelavega, Cantabria',NULL);
...
INSERT INTO `localizaciones` VALUES (1,'Polideportivo Emilio Amavisca','C. Reconquista de Sevilla, 39777 Laredo, Cantabria',NULL),(2,'Pabellón Municipal La Habana Vieja','Pabellón Deportivo, C. Pintor Varela, s/n, 39300 ',NULL),(3,'Pabellón deportivo IES Augusto González de Linares','Av. Primero de Mayo, 1, 39011 Santander, Cantabria',NULL),(4,'Pabellón Exterior de La Albericia','Av. del Deporte, 15, 39011 Santander, Cantabria',NULL);
...
CREATE TABLE `multimedia` (
  ...
  `fk_centro` int DEFAULT NULL, /*para el logo del centro*/
...
(1,'acicatech_blanco.png',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(2,'cantabria_informatica_blanco.png',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(3,'CIC_blanco.png',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(4,'Deduce_Data_Solutions_blanco.png',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(5,'deode_blanco.png',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(6,'ec.png',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(7,'EMI_hb.png',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(8,'infortec_blanco.png',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(9,'netkia_blanco.png',NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(10,'seidor_blanco.png',NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `patrocinadores` VALUES (1,3,'Acicatech Servicios Tecnológicos',NULL,NULL,NULL,NULL,1),(2,3,'Cantabria Informática',NULL,NULL,NULL,NULL,2),(3,3,'CIC',NULL,NULL,NULL,NULL,3),(4,3,'Deduce Data Solutions',NULL,NULL,NULL,NULL,4),(5,3,'Deode',NULL,NULL,NULL,NULL,5),(6,3,'EC',NULL,NULL,NULL,NULL,6),(7,3,'EMI Suite',NULL,NULL,NULL,NULL,7),(8,3,'Infortec',NULL,NULL,NULL,NULL,8),(9,3,'Netkia',NULL,NULL,NULL,NULL,9),(10,3,'Seidor',NULL,NULL,NULL,NULL,10);
...
INSERT INTO `sedes` VALUES (1,'Santander','Pabellón IES Augusto González de Linares','Av. Primero de Mayo, 1, 39011 Santander, Cantabria'),(2,'Torrelavega','Pabellón Municipal La Habana Vieja','Pabellón Deportivo, C. Pintor Varela, s/n, 39300 Torrelavega, Cantabria'),(3,'Laredo','Polideportivo Emilio Amavisca','C. Reconquista de Sevilla, 39777 Laredo, Cantabria');
...
INSERT INTO `torneos` VALUES (1,'Liga Solidaria FP Cantabria - Laredo',NULL,1,'2025-02-21','2025-06-21'),(2,'Liga Solidaria FP Cantabria - Torrelavega',NULL,2,'2025-02-14','2025-06-21'),(3,'Liga Solidaria FP Cantabria - Santander',NULL,3,'2025-03-21','2025-06-21'),(4,'Liga Solidaria FP Cantabria',NULL,4,'2025-04-29','2025-06-21');
...
-- Dump completed on 2025-01-31 13:14:50
...
-- Inserción de localizaciones (asegurando que no haya errores de FOREIGN KEY)
...
(2, 'Pabellón Municipal La Habana Vieja', 'Pabellón Deportivo, C. Pintor Varela, s/n, 39300 Torrelavega, Cantabria', NULL),
...
-- Inserción de patrocinadores (relacionados con torneo)
...
-- Inserción de sedes (relacionadas con localizacion)
...
-- Inserción de centros (relacionados con sedes)
...
-- Inserción de torneos (relacionados con localizaciones)
